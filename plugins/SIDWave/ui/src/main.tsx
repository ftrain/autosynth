 ...
 *
 * IMPORTANT: When bundled as IIFE with vite-plugin-singlefile, the inline
 * script executes in <head> before the <body> is parsed. We MUST wait for
 * DOMContentLoaded to ensure the #root element exists before mounting React.
 */
