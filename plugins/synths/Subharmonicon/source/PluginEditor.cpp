 ...
 * @brief WebView-based editor implementation for Subharmonicon
 */
...
void PluginEditor::sendSequencerStateToWebView()
{
    ...
    stateObj->setProperty("seq1Step", state.seq1Step);
    stateObj->setProperty("seq2Step", state.seq2Step);
    stateObj->setProperty("rhythm1Active", state.rhythm1Active);
    stateObj->setProperty("rhythm2Active", state.rhythm2Active);
    stateObj->setProperty("rhythm3Active", state.rhythm3Active);
    stateObj->setProperty("rhythm4Active", state.rhythm4Active);
